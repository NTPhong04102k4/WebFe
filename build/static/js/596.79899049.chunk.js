...
`;var V=s(2961),W=s(1133);const U=()=>{const e=(0,m.Zp)(),{isAuthenticated:t,user:s}=(0,V.A)(),[i,a]=(0,l.useState)({home:!1,listings:!1,blogs:!1,pages:!1}),n=e=>{a((()=>({listings:e===R.G.LISTINGS,blogs:e===R.G.BLOGS,pages:e===R.G.PAGES,home:e===R.G.HOME})))},r=()=>{a({listings:!1,blogs:!1,pages:!1,home:!1})};return(0,f.jsxs)(q,{children:[(0,f.jsxs)(Z,{children:[(0,f.jsx)(Y,{children:"BOXCARS"}),(0,f.jsx)(B,{label:"Home",dropdownOpen:i.home,toggleDropdown:()=>n(R.G.HOME),closeDropdowns:r,items:R.W.home}),(0,f.jsx)(B,{label:"Listings",dropdownOpen:i.listings,toggleDropdown:()=>n(R.G.LISTINGS),closeDropdowns:r,items:R.W.listings}),(0,f.jsx)(B,{label:"Blog",dropdownOpen:i.blogs,toggleDropdown:()=>n(R.G.BLOGS),closeDropdowns:r,items:R.W.blog}),(0,f.jsx)(B,{label:"Pages",dropdownOpen:i.pages,toggleDropdown:()=>n(R.G.PAGES),closeDropdowns:r,items:R.W.pages}),(0,f.jsx)(Q,{onClick:()=>{r(),e("/about")},children:"About"}),(0,f.jsx)(Q,{onClick:()=>{r(),e("/contact")},children:"Contact"}),(0,f.jsxs)(Q,{children:[" ",(0,f.jsx)(L.Jp1,{})," +75 123 456 789"]})]}),(0,f.jsx)(Z,{children:t?(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(Q,{children:(0,f.jsx)(j.zIN,{size:24})}),(0,f.jsx)(W.B,{theme:"light",name:(s?s.fullName?s.fullName:s.username?s.username:"User":"")||"User",closeAll:()=>a({listings:!1,blogs:!1,pages:!1,home:!1})})]}):(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(Q,{onClick:()=>e("/auth/login"),children:"Sign in"}),(0,f.jsx)(J,{style:{width:130},onClick:()=>e("/login/admin"),children:"Admin"})]})})]})},_=l.memo(U);_.displayName="HeaderBar";const q=i.Ay.div`
  flex-direction: row;
  display: flex;
...
`,Q=i.Ay.h1`
  ...
  position: relative;
  cursor: pointer;
`,K=[O,I,D],X=e=>{let{data:t}=e;const s=(0,m.Zp)(),[i,a]=(0,l.useState)(0),n=t;l.useEffect((()=>{const e=setInterval((()=>{a((e=>e<K.length-1?e+1:0))}),5e3);return()=>clearInterval(e)}),[]);const[r,c]=(0,l.useState)(""),[x,p]=(0,l.useState)([]),[u,h]=(0,l.useState)(-1),[g,b]=(0,l.useState)(!1),j=(0,l.useRef)(null),w=(0,l.useRef)(null),v=e=>{const t=e.target.value;c(t),(e=>{const t=G.w.filter((t=>t.name.toLowerCase().includes(e.toLowerCase())||t.body.toLowerCase().includes(e.toLowerCase())));p(t)})(t),h(-1)},y=e=>{requestAnimationFrame((()=>{(e=>{if(w.current){const t=w.current,s=t.children[e];if(s){const e=t.clientHeight,l=t.scrollTop,i=l+e,a=s.offsetHeight,n=s.offsetTop,r=n+a;r>i?t.scrollTop=r-e:n<l&&(t.scrollTop=n)}}})(e)}))},N=e=>{c(`${e.name} - ${e.body}`),p([]),h(-1),b(!1)};return(0,l.useEffect)((()=>{const e=e=>{g&&(e=>{var t;if(g&&0!==x.length)switch(e.key){case"ArrowDown":e.preventDefault(),h((e=>{const t=e===x.length-1?e:e+1;return y(t),t}));break;case"ArrowUp":e.preventDefault(),h((e=>{const t=e<=0?x.length-1:e-1;return y(t),t}));break;case"Enter":e.preventDefault(),u>=0&&u<x.length&&(N(x[u]),s("/cars/details",{state:{subItem:x[u]}}));break;case"Escape":e.preventDefault(),b(!1),null===(t=j.current)||void 0===t||t.blur(),p([])}})(e)};return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}}),[u,x,g]),(0,f.jsxs)("div",{className:"flex flex-col items-center justify-center",children:[(0,f.jsx)(_,{}),(0,f.jsxs)(ee,{img:K[i],children:[(0,f.jsx)(te,{children:"The World's Largest Used Car Dealership"}),(0,f.jsx)(se,{children:"Find Your Perfect Vehicle Online"}),(0,f.jsxs)("div",{className:"inline-flex w-full pl-7 pr-7 justify-between bg-transparent",children:[(0,f.jsx)(le,{onClick:()=>{a((e=>e>0?e-1:K.length))},children:(0,f.jsx)(d.SnO,{size:24,color:"#FFF"})}),(0,f.jsx)(le,{onClick:()=>{a((e=>e<K.length?e+1:0))},children:(0,f.jsx)(d.dH8,{size:24,color:"#FFF"})})]}),(0,f.jsx)(ie,{children:n.map(((e,t)=>{if(!e)return null;const l=e.data;return(0,f.jsxs)("div",{className:"flex flex-row flex-1 w-full",children:[(0,f.jsxs)(ae,{children:[(0,f.jsx)(ne,{onClick:()=>{0===e.id?s("/listings/car_old"):s("/listings/all")},children:l?null===e||void 0===e?void 0:e.name:(null===e||void 0===e?void 0:e.name)+" :"}),l?(0,f.jsx)(T.z44,{size:24,color:"#FFF",className:"cursor-pointer",onClick:()=>{0===e.id?s("/listings/car_old"):s("/listings/all")}}):(0,f.jsxs)("div",{className:"inline-flex 2xl:gap-8 justify-between gap-4 items-center",children:[(0,f.jsx)("p",{className:"font-medium text-[#FFF] text-[18px]",children:"All Prices"}),(0,f.jsxs)("div",{className:"relative",children:[(0,f.jsxs)("div",{className:"border-white border rounded w-auto flex flex-row justify-center items-center",children:[(0,f.jsx)("input",{ref:j,className:"text-[16px] focus:outline-none font-medium bg-transparent p-3 text-white w-full",placeholder:"Search Cars",value:r,onChange:v,onFocus:()=>b(!0),onClick:()=>b(!0)}),(0,f.jsx)("div",{className:"cursor-default mr-3 p-1 hover:scale-105 w-9 transition duration-300 flex items-center justify-center active:scale-95",children:(0,f.jsx)(o.M7W,{size:24,color:"#fff"})})]}),g&&x.length>0&&(0,f.jsx)("div",{ref:w,className:"absolute w-full mt-1 bg-white rounded-md shadow-lg max-h-60 overflow-auto z-50",children:x.map(((e,t)=>(0,f.jsxs)("div",{className:"p-2 cursor-pointer hover:bg-gray-100 "+(t===u?"bg-blue-100":""),onClick:()=>N(e),onMouseEnter:()=>h(t),children:[e.name," - ",e.body," ",e.priceBuy]},e.id)))})]})]})]}),(0,f.jsx)("div",{className:`${l&&"w-[1px]"} bg-white mt-2 mb-2 h-[80%]`})]},e.id)}))})]})]})},ee=i.Ay.div`
  width: 90%;
  margin-right: 90px;
  margin-left: 90px;
  background-image: url(${e=>e.img||I});
...
`,ne=i.Ay.h2`
  ...
  color: #ffffff;
  cursor: pointer;
`,re=l.memo((()=>(0,f.jsxs)(oe,{children:[(0,f.jsx)(X,{data:a.eV}),(0,f.jsx)(b.O,{data:a.Wz,title:"Select a Body Styles"}),(0,f.jsx)(v,{data:a.YN,title:"We're BIG on what matters to you"}),(0,f.jsx)(u,{data:G.w,title:" The Most Searched Cars"}),(0,f.jsx)(N,{data:a.QW}),(0,f.jsx)(g,{data:G.w,title:"Recommended Cars For You"}),(0,f.jsx)(y,{}),(0,f.jsx)(g,{data:G.w,title:"Upcoming Cars"}),(0,f.jsx)(C._x,{data:C.Hc}),(0,f.jsx)(E,{data:a.EU,title:"Latest Blog Posts"}),(0,f.jsx)(b.O,{title:"Explore Our Premium Brands",data:a.fg,detail:!0}),(0,f.jsx)(k,{})]}))),oe=i.Ay.div`
  display: flex;
  flex-direction: column;
  width: 100%;
...
//# sourceMappingURL=596.79899049.chunk.js.map