  ...
  return (
    ...
    >
      <div className="flex items-center shadow-sm justify-between h-16 border-b px-4">
        <h1 className={`font-bold text-xl transition-opacity duration-300 ${!isOpen ? 'opacity-0 hidden' : 'opacity-100'}`}>
          Admin
        </h1>
        <button
          onClick={onToggle}
  ...
  return (
    <div
      className={`
        ...
        ${activeTab ? 'bg-gray-100 border-l-4 border-blue-500 text-blue-700' : 'bg-white'}
      `}
      onClick={onClick}
    >
      <h3 className={`
