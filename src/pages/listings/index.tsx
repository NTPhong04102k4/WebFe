...
const mapCarToCarDetail = (car: CarResponseItem): CarDetail => {
  ...
  // Map body type - using default mapping since we don't have body type details in response
  // This is a simplified mapping, in production you might want to fetch body types separately
